...
let quantitySlides = slidesCollection.length; /* получаю количество слайдов для счетчика минус 1 тот что уже видно на  экране*/
...
let temp = -(quantitySlides * step / 2); /* переменная счетчик */
